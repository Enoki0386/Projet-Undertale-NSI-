    ...
    def run(self):
        ...
        while running:
            ...
            if self.state == 'exploration':
                ...
                if not self.minigame_active and (abs(self.map.player.rect.centerx - self.map.boss.rect.centerx) < 50 and abs(self.map.player.rect.centery - self.map.boss.rect.centery) < 50):
                    self.state = 'minigame'
